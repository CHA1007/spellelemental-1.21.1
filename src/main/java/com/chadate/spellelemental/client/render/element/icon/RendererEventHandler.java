...
import com.chadate.spellelemental.client.render.element.icon.custom.*;
...
public class RendererEventHandler {
    ...
    private static final Map<String, RendererConfig> RENDERER_CONFIGS = Map.of(
            "fire", new RendererConfig(0.15f, 0.9f),
            "ice", new RendererConfig(0.15f, 0.9f),
            "lightning", new RendererConfig(0.15f, 0.9f),
            "nature", new RendererConfig(0.15f, 0.9f),
            "water", new RendererConfig(0.15f, 0.9f),
            "blood", new RendererConfig(0.15f, 0.9f),
            "holy", new RendererConfig(0.15f, 0.9f),
            "ender",  new RendererConfig(0.15f, 0.9f),
            "freeze", new RendererConfig(0.15f, 0.9f),
            "promotion", new RendererConfig(0.15f, 0.9f)
            );

    // 使用LinkedHashMap保持插入顺序
    private static final Map<String, RendererFactory> RENDERER_FACTORIES = Map.of(
            "freeze", FreezeElementRenderer::new,
            "promotion", PromotionElementRenderer::new,
            ...
            "blood", BloodElementRenderer::new,
            "holy", HolyElementRenderer::new,
            "ender", EnderElementRenderer::new
    );
    ...
    private static final Map<String, Supplier<AttachmentType<ElementsAttachment>>> ATTACHMENT_MAPPING = Map.of(
            ...
            "promotion", SpellAttachments.PROMOTION_ELEMENT,
            ...
            "blood", SpellAttachments.BLOOD_ELEMENT,
            "holy", SpellAttachments.HOLY_ELEMENT,
            "ender", SpellAttachments.ENDER_ELEMENT
    );
